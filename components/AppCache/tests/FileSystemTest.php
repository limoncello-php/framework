...
class FileSystemTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFileCreateAndDelete()
    {
        ...
        $this->assertTrue($this->fileSystem->delete($tmpFileName));
        $this->assertFalse($this->fileSystem->exists($tmpFileName));

        $contents = 'Hello';
        $this->assertTrue($this->fileSystem->write($tmpFileName, $contents));
        $this->assertTrue($this->fileSystem->exists($tmpFileName));
    ...
    public function testScanFolder()
    {
        ...
        foreach ($this->fileSystem->scanFolder(__DIR__) as $fileOrFolder) {
            if (__FILE__ === __DIR__ . DIRECTORY_SEPARATOR . $fileOrFolder) {
    ...
    public function testFolderCreateAndDelete()
    {
        ...
        $this->assertTrue($this->fileSystem->delete($tmpFolderName));

        $this->assertFalse($this->fileSystem->exists($tmpFolderName));
        $this->assertTrue($this->fileSystem->createFolder($tmpFolderName));
        $this->assertTrue($this->fileSystem->exists($tmpFolderName));
        $this->assertTrue($this->fileSystem->isFolder($tmpFolderName));
        $this->assertTrue($this->fileSystem->deleteFolder($tmpFolderName));
        $this->assertFalse($this->fileSystem->exists($tmpFolderName));
    }
    ...
    public function testRecursiveDelete()
    {
        ...
        $this->assertTrue($this->fileSystem->deleteFolderRecursive($rootPath));
    }
    ...
    public function testRecursiveDeleteFailedOnFile()
    {
        ...
        $this->assertFalse($this->fileSystem->deleteFolderRecursive($rootPath));
    }
