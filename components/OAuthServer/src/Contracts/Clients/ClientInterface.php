<?php namespace Limoncello\OAuthServer\Contracts\Clients;
...
interface ClientInterface
{
    ...
    /**
     * Get `true` server should use client scope if no scope is given in authorization request. If `false` empty input
     * scope will lead to invalid_scope error.
     *
     * @return bool
     *
     * @link https://tools.ietf.org/html/rfc6749#section-3.3
